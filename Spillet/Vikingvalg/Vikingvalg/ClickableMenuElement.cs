...
{
    class ClickableMenuElement : MenuElement, IUseInput
    {
        public ClickableMenuElement(String artName, Rectangle destinationRectangle, Rectangle sourceRectangle, Color color, float rotation,
        ...
        { }
        public ClickableMenuElement(String artName, Rectangle destinationRectangle)
